...
async function _dates(d3) {
  const data = await d3.csv(
    "https://raw.githubusercontent.com/YuLan1014/covid/main/allcluster.csv",
    (d) => {
      return d.date;
    }
  );
...
async function _data(d3) {
  return Object.assign(
    new Map(
      await d3.csv(
        "https://raw.githubusercontent.com/YuLan1014/covid/main/allcluster.csv",
        ({ id, rr_c, rr_l, date }) => [id + " " + date, [+rr_c, +rr_l]]
      )
    ),
...
async function _all_data(FileAttachment) {
  return await FileAttachment("rr_limited_renew.csv").csv({ typed: true });
}

function _all_data2(d3) {
  return d3.csv(
    // "https://raw.githubusercontent.com/YuLan1014/covid/main/rr_all.csv",
    // "https://raw.githubusercontent.com/YuLan1014/covid/main/rr_2022010120220630new.csv",
    "https://raw.githubusercontent.com/YuLan1014/covid/main/allcluster.csv",
    d3.autoType
  );
}
...
export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([
    ...
    [
      "rr_limited_renew.csv",
      {
        url: new URL(
          "./files/33eb350bc2daf07454217cda283edd208afc1a85a68859edb2cf022258353daef4788d1b8d1909d6a99f7f8c2fce00dc6c621f2a98ee3d8eaffdee48a45576ff.csv",
          import.meta.url
        ),
        mimeType: "text/csv",
        toString,
    ...
    [
      ...
      {
        url: new URL(
          "./files/df282e3eaa5ea6b42173e7af925d893367dbe8581e28c3d997798c5676e3c86f7b566bcdcde6d2b543552c0be786b6780725217d81ab68a3aea7df4a0f8d1e2a.csv",
          import.meta.url
        ),
        mimeType: "text/csv",
        toString,
  ...
  main.variable(observer()).define(["topojson", "us"], _26);
  main
  ...
  main.variable(observer()).define(["topojson", "us"], _40);
