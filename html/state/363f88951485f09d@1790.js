// https://observablehq.com/@analyzer2004/svgtable@1790
...
function _dashboard(d3,options,SVGTable,data,resetGrid,miniChart,miniMap)
{
  const svg = d3.create("svg")
    .attr("font-size", `${options.fontsize}pt`)
    .attr("viewBox", [0, 0, 975, 610]);    
  
  document.body.append(svg.node()); // for autoSizeCell
...
async function _4(md,FileAttachment,tex){return(
...
function _6(d3,width,SVGTable,sample)
{
  const svg = d3.create("svg")
    .attr("font-size", "11pt")
...
function _SVGTable(Paginator,d3,Scrollbar){return(
class SVGTable {
...
function _10(d3,width,Scrollbar)
{
  const svg = d3.create("svg")
...
function _miniMap(d3,grid,seq,options,up){return(
...
function _miniChart(data,d3,options,up){return(
(svg, x, y, width, height) => {  
...
async function _data(options,getStates,d3,FileAttachment)
{
...
async function _states(d3,FileAttachment){return(
d3.csvParse(await FileAttachment("statecodes@1.csv").text())
)}

function _grid(states,data)
{
...
function _getStates(covid){return(
field => {
...
function _resetGrid(grid){return(
() => grid.forEach(d => d.value = null)
)}

async function _sample(d3,FileAttachment){return(
...
export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([
    ["anatomy.png", {url: new URL("./files/88e006c569903c680cb3b8bf4d00a750f15c5e7c5fc8b62a97b410160d58c3adc1ff4bc58bddf8ce9fb31dd92da671bbd11ac0dba48d9cf3b2b5986538e2b324.png", import.meta.url), mimeType: "image/png", toString}],
    ["profit@1.csv", {url: new URL("./files/7a88681c221d6f70d624144ad2c81c5414c9b3a390f5245fd2cde6b4efef3bdfdc208619fce1ebd64fad0be71ba3acd0e54ea1440daf5a797108b52c3ae9b2e2.csv", import.meta.url), mimeType: "text/csv", toString}],
    ["statecodes@1.csv", {url: new URL("./files/c65af6575dd3c4c20bc9e2d9af272c3fc409d4f9c8324c68395e4042d8a772a3ce6d9ddfd8a0b2dcaf1e900319cd786c5744cbb9d15d50d4e2c7acc721259e64.csv", import.meta.url), mimeType: "text/csv", toString}],
    ["sea19.csv", {url: new URL("./files/df1cfc7ac78875e86695d62e7b1094475334eda9f204b5d22f24ec31d8af006fb6e67e5f26c4d67d53566281815cab0f401ac048396d678661c55f8c9f927919.csv", import.meta.url), mimeType: "text/csv", toString}]
  ]);
  ...
  main.variable(observer("dashboard")).define("dashboard", ["d3","options","SVGTable","data","resetGrid","miniChart","miniMap"], _dashboard);
  main.variable(observer()).define(["md","FileAttachment","tex"], _4);
  main.variable(observer()).define(["md"], _5);
  main.variable(observer()).define(["d3","width","SVGTable","sample"], _6);
  main.variable(observer()).define(["md"], _7);
  main.variable(observer("SVGTable")).define("SVGTable", ["Paginator","d3","Scrollbar"], _SVGTable);
  main.variable(observer()).define(["md"], _9);
  main.variable(observer()).define(["d3","width","Scrollbar"], _10);
  main.variable(observer()).define(["md"], _11);
  main.variable(observer("Scrollbar")).define("Scrollbar", ["d3"], _Scrollbar);
  main.variable(observer()).define(["md"], _13);
  main.variable(observer("Paginator")).define("Paginator", ["d3"], _Paginator);
  main.variable(observer()).define(["md"], _15);
  main.variable(observer()).define(["md"], _16);
  main.variable(observer("miniMap")).define("miniMap", ["d3","grid","seq","options","up"], _miniMap);
  main.variable(observer("miniChart")).define("miniChart", ["data","d3","options","up"], _miniChart);
  main.variable(observer()).define(["md"], _19);
  main.variable(observer("data")).define("data", ["options","getStates","d3","FileAttachment"], _data);
  main.variable(observer("states")).define("states", ["d3","FileAttachment"], _states);
  main.variable(observer("grid")).define("grid", ["states","data"], _grid);
  main.variable(observer()).define(["md"], _23);
  main.variable(observer("getStates")).define("getStates", ["covid"], _getStates);
  main.variable(observer("covid")).define("covid", ["d3"], _covid);
  main.variable(observer()).define(["md"], _26);
  main.variable(observer()).define(["html"], _27);
  main.variable(observer("seq")).define("seq", _seq);
  main.variable(observer("up")).define("up", _up);
  main.variable(observer("resetGrid")).define("resetGrid", ["grid"], _resetGrid);
  main.variable(observer("sample")).define("sample", ["d3","FileAttachment"], _sample);
