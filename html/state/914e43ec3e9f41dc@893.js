...
import define3 from "./450051d7f1174df8@254.js";
...
function _chart(d3,options,GridMap,covid,map)
{
...
function _dn(Scrubber,d3,days){return(
...
function _options2(form,html){return(
form(html`<form style="font-size: 12pt">
...
function _chart2(d3,firstDay,dn,getStatesNumber,options2,GridMap,map)
{
  const svg = d3.create("svg")
    .attr("font-size", "9pt")
    .attr("viewBox", "0 0 1024 700");  
...
function _chart3(d3,GridMap,socal)
{
  const svg = d3.create("svg")
    .attr("font-size", "9pt")
    .attr("width", 400)
...
function _chart4(d3,width,GridMap,socal,sales)
{
  const svg = d3.create("svg")
    .attr("font-size", "9pt")
    .attr("width", width)
...
function _chart5(d3,width,GridMap,socal,qtrsales)
{
  const svg = d3.create("svg")
    .attr("font-size", "9pt")
    .attr("width", width)
...
function _chart6(d3,width,GridMap,socal,qtrsales,seq)
{
  const svg = d3.create("svg")
    .attr("font-size", "9pt")
    .attr("width", width)
...
function _options3(form,html){return(
form(html`<form>
...
function _chart7(d3,getStatesLastNDays,GridMap,options3,map)
{
  const svg = d3.create("svg")
    .attr("font-size", "9pt")
    .attr("viewBox", "0 0 1024 700");  
...
function _editor(extent,d3,seq)
{
  extent();
...
function _covid(getStatesLastNDays,options){return(
getStatesLastNDays(options.field, options.days, false, true)
)}

function* _33(d3,width,SVGTable,covid)
{
  const svg = d3.create("svg")
    .attr("font-size", "11pt")
...
export default function define(runtime, observer) {
  ...
  main.variable(observer("chart")).define("chart", ["d3","options","GridMap","covid","map"], _chart);
  main.variable(observer()).define(["md"], _4);
  main.variable(observer("viewof dn")).define("viewof dn", ["Scrubber","d3","days"], _dn);
  main.variable(observer("dn")).define("dn", ["Generators", "viewof dn"], (G, _) => G.input(_));
  main.variable(observer("viewof options2")).define("viewof options2", ["form","html"], _options2);
  main.variable(observer("options2")).define("options2", ["Generators", "viewof options2"], (G, _) => G.input(_));
  main.variable(observer("chart2")).define("chart2", ["d3","firstDay","dn","getStatesNumber","options2","GridMap","map"], _chart2);
  main.variable(observer()).define(["md"], _8);
  main.variable(observer()).define(["md"], _9);
  main.variable(observer("chart3")).define("chart3", ["d3","GridMap","socal"], _chart3);
  main.variable(observer()).define(["md"], _11);
  main.variable(observer("chart4")).define("chart4", ["d3","width","GridMap","socal","sales"], _chart4);
  main.variable(observer()).define(["md"], _13);
  main.variable(observer("chart5")).define("chart5", ["d3","width","GridMap","socal","qtrsales"], _chart5);
  main.variable(observer()).define(["md"], _15);
  main.variable(observer("chart6")).define("chart6", ["d3","width","GridMap","socal","qtrsales","seq"], _chart6);
  main.variable(observer()).define(["md"], _17);
  main.variable(observer("viewof options3")).define("viewof options3", ["form","html"], _options3);
  main.variable(observer("options3")).define("options3", ["Generators", "viewof options3"], (G, _) => G.input(_));
  main.variable(observer("chart7")).define("chart7", ["d3","getStatesLastNDays","GridMap","options3","map"], _chart7);
  main.variable(observer("socal")).define("socal", _socal);
  main.variable(observer("sales")).define("sales", _sales);
  main.variable(observer("qtrsales")).define("qtrsales", _qtrsales);
  main.variable(observer()).define(["md"], _23);
  main.variable(observer()).define(["md"], _24);
  main.variable(observer("GridMap")).define("GridMap", ["d3"], _GridMap);
  main.variable(observer()).define(["md"], _26);
  main.variable(observer("editor")).define("editor", ["extent","d3","seq"], _editor);
  main.variable(observer()).define(["md"], _28);
  main.variable(observer("extent")).define("extent", ["d3"], _extent);
  main.variable(observer("seq")).define("seq", _seq);
  main.variable(observer("map")).define("map", _map);
  main.variable(observer("covid")).define("covid", ["getStatesLastNDays","options"], _covid);
  main.variable(observer()).define(["d3","width","SVGTable","covid"], _33);
  main.variable(observer()).define(["html"], _34);
  main.variable(observer()).define(["options"], _35);
