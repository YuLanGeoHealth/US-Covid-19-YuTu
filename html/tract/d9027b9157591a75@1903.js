 ...
 // create SVG element
  ...
  var countyMap = bim.append("g")
   //.attr("transform","translate("+margin*25+","+margin+") scale(0.7)")
    .selectAll("path")
    .data(topojson.feature(us, us.objects.wi).features)
    .join("path")
  ...
  bim.append("path")
      .datum(topojson.mesh(us, us.objects.wi, (a, b) => a !== b))
     // .attr("transform","translate("+margin*25+","+margin+") scale(0.7)")
      .attr("fill", "none")
      .attr("stroke", "white")
...
{
  const data = await d3.csv( "https://raw.githubusercontent.com/YuLan1014/covid/main/wi_tract_cluster.csv", d => {
    return d.date;
  });
  return [...new Set(data)];
}
...
Object.assign(new Map(
  await d3.csv(  "https://raw.githubusercontent.com/YuLan1014/covid/main/wi_tract_cluster.csv", ({ID,RR_C,RR_L,date}) => [(ID+ " "+date), [+RR_C, +RR_L]])), 
...
d3.csv(
    "https://raw.githubusercontent.com/YuLan1014/covid/main/wi_tract_rr.csv",
...
d3.csv(
  // "https://raw.githubusercontent.com/YuLan1014/covid/main/rr_all.csv",
  "https://raw.githubusercontent.com/YuLan1014/covid/main/wi_tract_cluster.csv",
  // "https://raw.githubusercontent.com/YuLan1014/covid/main/allgis_res_2021.csv",
...
function _38(us){return(
us.objects
)}

function _states(us){return(
new Map(us.objects.wi.geometries.map(d => [d.id, d.properties.GEOID]))
)}

function _us(FileAttachment){return(
FileAttachment("wib_new.json").json()
)}
...
export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([
    ["wib_new.json", {url: new URL("./files/d273edf4eccc49502b370664ac265d904870ce1ea9e6e8de3591277e7fa62bf0e70a84490b76c40ea11c87d6855ae835383d74e5edcf844f8fae287e0d864d22.json", import.meta.url), mimeType: "application/json", toString}]
  ]);
  ...
  main.variable(observer()).define(["us"], _38);
